...
|-----|----------|-----------|----------
|15h15-15h45|Christophe Crespelle (MC3) <br> Open problems in complex networks analysis and modelling|Luigi Liquori (Kairos) <br> [Redactable smart contracts in electronic ledgers (blockchain)](resumes/luigi-liquori.txt)|Étienne Lozes (SCALE) <br> [Do LLMs really scale?](resumes/etienne-lozes.txt)
|15h45-16h15|Ramon Aparicio (SIGNET) <br> [Can flexible AI workloads to stabilise electrical grids ? / Quantum Network AI-based Control ](resumes/ramon-aparicio2.txt) |Anéva Doliciane Tsafack (Morphème) <br> [Imagerie de microscopie pour la biologie](resumes/aneva-doliciane-tsafack.txt)| 
