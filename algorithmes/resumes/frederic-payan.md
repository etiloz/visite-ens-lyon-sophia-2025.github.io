...
-------------------------------
Mediacoding conducts innovative research on digital data storage in synthetic DNA, exploring its potential as a sustainable and ultra-compact solution for long-term archiving. Our work aims to develop reliable encoding and decoding protocols adapted to biochemical constraints and growing storage capacity needs. We are also developing tools for analysing the 3D geometry of molecules to identify structural similarities and better understand nanopore sequencing mechanisms.
Mediacoding is a major actor in the PEPR MolecularXiv (funded by France 2030), which focuses on molecular data storage.

Keywords: digital data encoding/decoding, signal and image processing, 3D geometry processing, information theory, computer graphics"
